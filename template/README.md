...
- ⛶ **Responsive Tiling & Full-Playfield View (`Shift+F` / `⇧F`):** Hotkey and subheader pill that collapses the full header into a sleek 38px floating micro-HUD for split-screen Hyprland tiling and focused edge-to-edge play.
