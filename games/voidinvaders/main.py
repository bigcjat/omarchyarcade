#!/usr/bin/env python3
"""
VoidInvaders - Sleek Modern Retro Space Invaders for macOS & Omarchy Linux.
Features:
...
class SettingsManager(QObject):
    def __init__(self, parent=None):
        ...
        self.settings = QSettings("Arcade", "VoidInvaders")
...
class SoundManager(QObject):
    ...
    def preload_sounds(self):
        sound_names = ["explode", "invader_move", "player_die", "shoot", "ufo"]
...
def load_system_theme():
    ...
    try:
        ...
        return {
            ...
            "color8": colors.get("color8", colors.get("color0", "#313244")),
        }
    except Exception:
        return None
...
def main():
    ...
    disk_candidates = [
        ...
        script_dir.parent.parent / "assets" / "covers" / "voidinvaders_disk.png",
        Path.home() / ".local" / "share" / "omarchy-arcade" / "assets" / "covers" / "voidinvaders_disk.png",
    ]
