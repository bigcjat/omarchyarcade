#!/usr/bin/env python3
"""
Omarchy Arcade • Reversi (Othello)
...
def main():
    ...
    app.setApplicationName("Reversi")
    ...
    disk_candidates = [
        ...
        script_dir.parent.parent / "assets" / "covers" / "reversi_disk.png",
        Path.home() / ".local" / "share" / "omarchy-arcade" / "assets" / "covers" / "reversi_disk.png",
    ]
    ...
    settings_mgr = SettingsManager("Reversi")
    ...
    if theme_arg:
        ...
        if clean_arg in DEFAULT_PRESETS:
            ...
            if custom_path.is_file():
                ...
                print(f"Warning: Theme '{theme_arg}' not found. Falling back to default preset.", file=sys.stderr)
    ...
    print("Reversi running. Press Esc or ? for help, R to restart.")
    sys.exit(app.exec())
