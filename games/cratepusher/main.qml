    ...
    Item {
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Text {
                            ...
                            font.pixelSize: 16
                            font.bold: true
                            color: root.bestMoves > 0 ? (root.isDarkMode ? root.themeAccent : "#15803d") : (root.isDarkMode ? root.themeSubtext : "#94a3b8")
                        }
                    }
                }
            }
        ...
        Rectangle {
            ...
            Row {
                ...
                Text {
                    text: "• " + ("LVL " + (root.currentLevelIndex + 1))
                    font.pixelSize: 11
                    font.bold: true
                    color: root.themeFg
                }
                Text {
                    text: "(" + ("MOVES: " + root.moveCount) + ")"
                    font.pixelSize: 10
                    color: root.themeSubtext
                }
            }
        ...
        Rectangle {
            ...
            height: 28
            radius: 14
            color: root.isDarkMode ? "#e6181825" : "#f1f5f9"
            border.color: root.isDarkMode ? root.themeBorder : "#cbd5e1"
            border.width: 1
            opacity: 0
            z: 800
