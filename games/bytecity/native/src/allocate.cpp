...
void Micropolis::initMapArrays()
{
    ...
    resHist = (short *)newPtr(sizeof(short) * HISTORY_LENGTH);
    comHist = (short *)newPtr(sizeof(short) * HISTORY_LENGTH);
    indHist = (short *)newPtr(sizeof(short) * HISTORY_LENGTH);
    moneyHist = (short *)newPtr(sizeof(short) * HISTORY_LENGTH);
    pollutionHist = (short *)newPtr(sizeof(short) * HISTORY_LENGTH);
    crimeHist = (short *)newPtr(sizeof(short) * HISTORY_LENGTH);
    miscHist = (short *)newPtr(sizeof(short) * MISC_HISTORY_LENGTH);
