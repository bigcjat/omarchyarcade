        ...
        Item {
            ...
            Row {
                ...
                Column {
                    ...
                    Text {
                        text: Engine.score + (highScore > 0 ? " • HI " + highScore : " pts")
                        font.pixelSize: 10
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text { text: Engine.lives.toString(); font.pixelSize: 10; font.bold: true; font.family: root.monoFontFamily; color: root.themeFg; anchors.verticalCenter: parent.verticalCenter }
                    }
                }
