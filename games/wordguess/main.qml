...
• Mute: M | Restart: Ctrl+R | Help: ?"
        ...
        Engine.submitGuess({
            ...
            onGameOver: function(won) {
                ...
                if (typeof settingsManager !== "undefined" && settingsManager) {
                    settingsManager.setValue("wins", root.wins.toString());
                    settingsManager.setValue("streak", root.streak.toString());
                }
            }
        });
        syncBoard();
    ...
    Component.onCompleted: {
        ...
        root.targetWord = Engine.targetWord;
        if (typeof settingsManager !== "undefined" && settingsManager) {
            root.wins = parseInt(settingsManager.getValue("wins", "0")) || 0;
            root.streak = parseInt(settingsManager.getValue("streak", "0")) || 0;
        }
    }
}
