...
def main():
    ...
    if "--help" in sys.argv or "-h" in sys.argv:
        print("ByteMan \u2022 Retro Maze Chaser")
        sys.exit(0)
    ...
    app.setApplicationName("ByteMan")
    app.setOrganizationName("Arcade")
    # Set application icon to game floppy disk
    script_dir = Path(__file__).resolve().parent
    disk_candidates = [
        script_dir / "assets" / "disk_icon.png",
        script_dir.parent.parent / "assets" / "covers" / "byteman_disk.png",
        Path.home() / ".local" / "share" / "omarchy-arcade" / "assets" / "covers" / "byteman_disk.png",
    ]
    ...
    settings_mgr = SettingsManager("ByteMan")
