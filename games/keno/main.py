...
class SettingsManager(QObject):
    """Provides local persistence via QSettings for Keno bankroll & best win."""
    def __init__(self, game_id="Keno", parent=None):
...
def main():
    ...
    app.setApplicationName("Modern Keno")
    ...
    settings_mgr = SettingsManager("Keno")
