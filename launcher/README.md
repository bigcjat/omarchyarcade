...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Games-20%20Included-ec4899?style=flat-square" alt="20 Games"/>
...
**Omarchy Arcade** is a dedicated, distraction-free desktop game launcher and catalog of 20 full-featured offline arcade games built specifically for **Omarchy Linux** and tiling window managers (Hyprland).
...
* 🎮 **20 Built-In Games:** Blocks, puzzles, retro vector space combat, brick breakers, city simulation, and classic action arcade games—ready to launch in milliseconds.
